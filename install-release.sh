...
downloadV2Ray(){
    ...
    DOWNLOAD_LINK="https://github.com/ColetteContreras/v2ray-poseidon/releases/download/v0.4.0/v2ray-linux-64.zip"
...
getVersion(){
    if [[ -n "$VERSION" ]]; then
        ...
        TAG_URL="https://api.github.com/repos/ColetteContreras/v2ray-ssrpanel-plugin/releases"
